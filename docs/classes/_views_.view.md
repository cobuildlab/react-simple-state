...
*Defined in [src/views.ts:9](https://github.com/cobuildlab/react-simple-state/blob/69c0983/src/views.ts#L9)*
...
*Defined in [src/views.ts:7](https://github.com/cobuildlab/react-simple-state/blob/69c0983/src/views.ts#L7)*
...
*Defined in [src/views.ts:8](https://github.com/cobuildlab/react-simple-state/blob/69c0983/src/views.ts#L8)*
...
*Defined in [src/views.ts:32](https://github.com/cobuildlab/react-simple-state/blob/69c0983/src/views.ts#L32)*
...
*Defined in [src/views.ts:57](https://github.com/cobuildlab/react-simple-state/blob/69c0983/src/views.ts#L57)*
...
*Defined in [src/views.ts:20](https://github.com/cobuildlab/react-simple-state/blob/69c0983/src/views.ts#L20)*
