...
*Defined in [src/views.ts:9](https://github.com/cobuildlab/react-simple-state/blob/4d0bc58/src/views.ts#L9)*
...
*Defined in [src/views.ts:7](https://github.com/cobuildlab/react-simple-state/blob/4d0bc58/src/views.ts#L7)*
...
*Defined in [src/views.ts:8](https://github.com/cobuildlab/react-simple-state/blob/4d0bc58/src/views.ts#L8)*
...
*Defined in [src/views.ts:27](https://github.com/cobuildlab/react-simple-state/blob/4d0bc58/src/views.ts#L27)*
...
*Defined in [src/views.ts:47](https://github.com/cobuildlab/react-simple-state/blob/4d0bc58/src/views.ts#L47)*
...
*Defined in [src/views.ts:19](https://github.com/cobuildlab/react-simple-state/blob/4d0bc58/src/views.ts#L19)*
