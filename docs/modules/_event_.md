...
*Defined in [src/event.ts:10](https://github.com/cobuildlab/react-simple-state/blob/69c0983/src/event.ts#L10)*
...
*Defined in [src/event.ts:8](https://github.com/cobuildlab/react-simple-state/blob/69c0983/src/event.ts#L8)*
...
*Defined in [src/event.ts:78](https://github.com/cobuildlab/react-simple-state/blob/69c0983/src/event.ts#L78)*
